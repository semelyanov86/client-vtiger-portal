const enMessages = {
  ...
  'user-settings.settings': 'Your settings',
  ...
  'projects.targetenddate': 'Target End Date',
  'projects.actualenddate': 'Actual End Date',
  'projects.projectstatus': 'Project Status',
  'projects.projecttype': 'Project Type',
  'projects.project_no': 'Project Number',
  'projects.targetbudget': 'Target Budget',
  'projects.projecturl': 'Project URL',
  'projects.projectpriority': 'Project Priority',
  'projects.progress': 'Progress',
  'projects.potentialid': 'Potential ID',
  'projects.description': 'Project Description',
  'projects.id': 'Project ID',
  'projects.label': 'Project Label',
  'projects.Внедрен': 'Implemented',
  'projects.Обсуждение': 'Discussions',
  'projects.Выполняется': 'In Progress',
  'projects.Ознакомление': 'Checking Requirenments',
  'projects.initiated': 'Initiated',
  'projects.prospecting': 'Prospecting',
  'projects.delivered': 'Delivered',
  'projects.in progress': 'In Progress',
  'projects.waiting for feedback': 'Waiting for feedback',
  ...
  'projects.Высокий': 'High',
  'projects.high': 'High',
  'projects.low': 'Low',
  'projects.detail': 'Project detail: ',
  'projects.info': 'Project Information',
  'projects.total_tasks': 'Total Tasks',
  'projects.total_hours': 'Total Hours',
  'projects.open_tasks': 'Open Tasks',
  'projects.closed_tasks': 'Closed Tasks',
  'projects.in_progress_tasks': 'In Progress Tasks',
  'projects.deferred_tasks': 'Deferred Tasks',
  'projects.cancelled_tasks': 'Cancelled Tasks',
  'projects.low_tasks': 'Low Tasks',
  'projects.normal_tasks': 'Normal Tasks',
  'projects.high_tasks': 'High Tasks',
  'projects.basic-info': 'Basic Information',
  'projects.manager': 'Assigned Manager',
  'projects.createdtime': 'Created Time',
  'projects.documents': 'Attached documents',
  'projects.comments': 'Comments',
  'projects.progress-tasks': 'Tasks at in progress projects',
  ...
  'sales-orders.salesorder_no': 'Sales Order No',
  'sales-orders.subject': 'Subject',
  'sales-orders.hdnGrandTotal': 'Total',
  'sales-orders.hdnSubTotal': 'Subtotal',
  'sales-orders.shipping': 'Shipping and Handling',
  'sales-orders.tax': 'Handling Taxes',
  'sales-orders.createdtime': 'Date & Time',
  'sales-orders.sostatus': 'Status',
  'sales-orders.Created': 'Created',
  'sales-orders.Cancel': 'Cancelled',
  'sales-orders.Approved': 'Approved',
  'sales-orders.Delivered': 'Delivered',
  'sales-orders.view-invoice': 'View Invoice',
  'sales-orders.main-info': 'Basic Information',
  'sales-orders.pending': 'Pending',
  'sales-orders.carrier': 'Carrier',
  'sales-orders.duedate': 'Payment Due Date',
  'sales-orders.cart': 'Cart',
  'sales-orders.payment': 'Make a payment',
  'sales-orders.description': 'Description',
  'sales-orders.address': 'Address',
  'sales-orders.billing-address': 'Billing Address',
  'sales-orders.shipping-address': 'Shipping Address',
  'sales-orders.bill_street': 'Street',
  'sales-orders.ship_street': 'Street',
  'sales-orders.bill_city': 'City',
  'sales-orders.ship_city': 'City',
  'sales-orders.bill_state': 'State',
  'sales-orders.ship_state': 'State',
  'sales-orders.bill_code': 'Code',
  'sales-orders.ship_code': 'Code',
  'sales-orders.bill_country': 'Country',
  'sales-orders.ship_country': 'Country',
  'sales-orders.bill_pobox': 'PO Box',
  'sales-orders.ship_pobox': 'PO Box',
  'sales-orders.manager': 'Assigned Manager',
