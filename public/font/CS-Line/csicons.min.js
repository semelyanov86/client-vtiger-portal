!(function (C, t) {
  ...
  return (() => {
        ...
        269: (C, t, a) => {
          ...
          const V = class {
              constructor(C, t) {
                (this.name = C),
                  (this.contents = t),
                  (this.attrs = d(d({}, M), { class: 'cs-icon cs-icon-'.concat(C) }));
              }
              toSvg() {
          ...
          function n(C) {
            return Array.from(C.attributes).reduce((C, t) => {
              ...
              return (
                'size' === a ? ((C.width = t.value), (C.height = t.value)) : (C[a] = t.value), C
              );
            }, {});
          }
          const s = function () {
            ...
            if ('undefined' == typeof document)
              throw new Error('`csicons.replace()` only works in a browser environment.');
                  ...
                  'string' === M
                    ...
                    ? (function (C, t) {
                        if (t.toString === Object.prototype.toString)
                          for (var p in t) a.call(t, p) && (C[p] = !!t[p]);
                        else C[t.toString()] = !0;
                      })(C, h)
                    : 'number' === M &&
                      (function (C, t) {
    ...
    return (
      ...
      (a.d = (C, t) => {
        for (var p in t)
          a.o(t, p) && !a.o(C, p) && Object.defineProperty(C, p, { enumerable: !0, get: t[p] });
      }),
